        ...
        <section id="projects" className="py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mx-auto max-w-3xl mb-16">
                    <span className="text-secondary-foreground text-sm font-medium tracking-wider uppercase animate-fade-in">Deploy Log</span>
                    ...
                    <p className="text-muted-foreground animate-fade-in animation-delay-200">
                        Recent projects and shipped features.
                    </p>
                </div>
                        ...
                        <div key={idx} className="group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1"
                            ...
                            <div className="relative overflow-hidden aspect-video">
                                <img
                                    ...
                                    onError={(e) => {
                                        if (e.currentTarget.src !== "/projects/default.png") {
                ...
                <div className="text-center mt-12 animate-fade-in animation-delay-500">
                    <a target="_blank" href="https://github.com/Jeyzii?tab=repositories">
