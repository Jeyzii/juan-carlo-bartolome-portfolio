    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden">
            <div className="absolute inset-0">
                <img src="/hero-bg.webp" alt="Hero image" className="w-full h-full object-cover opacity-40"/>
                    ...
                    <div className="space-y-8 ">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                                Transforming <span className="text-primary glow-text">blank slates</span>
                                <br />
                                into tools that make
                                <br />
                        ...
                        <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                            ...
                            {[
                                {icon: Github, href: "https://github.com/Jeyzii"},
                                {icon: Linkedin, href: "https://www.linkedin.com/in/juan-carlo-bartolome/"},
                            ].map((social, idx) => (
                                <a 
                                    target="blank"
                                    key={idx} 
                    ...
                    <div className="relative animate-fade-in animation-delay-300">
                        <div className="relative max-w-md mx-auto">
                            ...
                            <div className="relative glass rounded-3xl p-2 glow-border">
                                <img src="/profile-photo.png" alt="Juan Carlo Bartolome" className="w-full aspect-[4/5] object-cover rounded-2xl"/>
                                ...
                                <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
                                    <div className="text-2xl font-bold text-pretty">3+</div>
                                    <div className="text-xs text-muted-foreground">Years of Exp.</div>
                                </div>
                            </div>
                        </div>
                    </div>
