            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                <div className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium mb-12">Name</label>
                            <input id="name" 
                                    type="text" 
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium mb-12">Email</label>
                            <input id="email" 
                                    type="email" 
                        ...
                        <div>
                            <label htmlFor="message" className="block text-sm font-medium mb-12">Message</label>
                            <textarea rows={5}
                                    id="message" 
